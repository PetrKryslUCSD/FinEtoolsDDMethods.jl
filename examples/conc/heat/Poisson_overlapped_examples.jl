...
function Poisson_FE_H20_example(N, nelperpart, nbf1max, nfpartitions, overlap, itmax, relrestol, visualize)
    ...
    @info("Total time elapsed = $(time() - t0) [s]")
...
function test(; kind = "H20", N = 25, nelperpart = 200, nbf1max = 5, nfpartitions = 2, overlap = 1, itmax = 2000, relrestol = 1e-6, visualize = false)
    Poisson_FE_H20_example(N, nelperpart, nbf1max, nfpartitions, overlap, itmax, relrestol, visualize)
end
